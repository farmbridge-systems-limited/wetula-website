            ...
            <div id="legal-container" class="container">
                ...
                <main class="content w-100">
                    <div id="intro">
                        ...
                        <h2 class="text-center fg-orange">Who we are</h2>
                        ...
                        <h2 class="text-center fg-orange mt-15">How We Collect Information about You and Your Consent</h2>
                        <p class="text-leader2">
                        ...
                        <h2 class="text-center fg-orange mt-15">How We Keep Your Information Safe</h2>
                        ...
                        <h2 class="text-center fg-orange mt-15">
                    ...
                    <p class="text-leader2">We gather information about you and the products and services you use, or ask us about. We use this information to:</p>
                        ...
                        <h2 class="text-center fg-orange mt-15">Your Information and Third Parties</h2>
                        <p class="text-leader2">
                        ...
                        <h2 class="text-center fg-orange mt-15">Accessing and Managing Your Information</h2>
                        <p class="text-leader2">
